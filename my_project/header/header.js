         ...
         <ul>
             <li>
                 ...
                 <ul>
                     ...
                     <a href="/login/signup/login.html"><button id="login">LOGIN</button></a>
                     </li>
                     <li><br>
                     <a href="/login/signup/register.html"><button id="register">REGISTER</button></a>
                     </li>
                     <li>
                         <a href="">Wish list</a>
                     </li>
...
<nav>
    ...
    <li class="drpdown"><a href="/Ahsan_skinCare/home.html">Skin care</a>
        <ul class="menu-area">
            <ul>
            ...
            <ul>
                ...
                <li><a href="/Ahsan_skinCare/Cleansers.html">Cleansers</a></li>
                <li><a href="/Ahsan_skinCare/Moisturizers.html">Moisturizers</a></li>
                <li><a href="/Ahsan_skinCare/Serums.html">Serums</a></li>
                <li><a href="/Ahsan_skinCare/Eye Serum.html">Eye Serum</a></li>
                <li><a href="/Ahsan_skinCare/Eye Care.html">Eye Care</a></li>
               
            </ul>
            <ul>
                <h4>By Ingredient</h4>
                <li><a href="/Ahsan_skinCare/Vitamin C.html">Vitamin C</a></li>
                <li><a href="/Ahsan_skinCare/AHA.html">AHA</a></li>
                <li><a href="/Ahsan_skinCare/Caffeine.html">Caffeine</a></li>
                <li><a href="/Ahsan_skinCare/Retinol.html">Retinol</a></li>
                <li><a href="/Ahsan_skinCare/Lactic Acid.html">Lactic Acid</a></li>
                <li><a href="/Ahsan_skinCare/Glycolic Acid.html">Glycolic Acid</a></li>
                <li><a href="/Ahsan_skinCare/Azelaic Acid.html">Azelaic Acid</a></li>
            </ul>
            <ul>
                <h4>By Specific Concern</h4>
                <li><a href="/Ahsan_skinCare/Acne & Blemishes.html">Acne & Blemishes</a></li>
                <li><a href="/Ahsan_skinCare/Fine Lines & Wrinkles">Fine Lines & Wrinkles</a></li>
                <li><a href="/Ahsan_skinCare/Dark Circles.html">Dark Circles</a></li>
                <li><a href="/Ahsan_skinCare/Dry Skin.html">Dry Skin</a></li>
                <li><a href="/Ahsan_skinCare/Pregnancy Skincare.html">Pregnancy Skincare</a></li>
                <li><a href="/Ahsan_skinCare/Sensitive Skin.html">Sensitive Skin</a></li>
            </ul>
            <ul>
                <h4>Sunscreen & Suncare</h4>
                <li><a href="/Ahsan_skinCare/After Sun.html">After Sun</a></li>
                <li><a href="/Ahsan_skinCare/Tinted.html">Tinted</a></li>
                <li><a href="/Ahsan_skinCare/Mineral.html">Mineral</a></li>
                <li><a href="/Ahsan_skinCare/Eye Protection.html">Eye Protection</a></li>
            </ul>
        </ul>
    </li>
    ...
    <li class="drpdown"><a href="/makup.html">Makeup</a>
        <ul class="menu-area">
            <ul>
                <h4>Popular Categories</h4>
                <li><a href="">View All Cosmetics</a></li>
